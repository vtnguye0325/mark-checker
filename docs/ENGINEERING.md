...
See [the README](../README.md) for the user-facing walk-through and screenshots.

![The finding "Distinctive" with a score of 0.98, and the Abercrombie spectrum](assets/02-the-verdict.jpg)
...
| [PLAN.md](PLAN.md) | Design decisions behind the RAG layer |
...
See [DEPLOYMENT.md](DEPLOYMENT.md) for the full setup and a public deployment.
...
Built by Vy Nguyen. The classifier extends an MS thesis on
